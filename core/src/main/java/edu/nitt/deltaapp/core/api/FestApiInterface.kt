...
import edu.nitt.deltaapp.core.model.payload.AboutUs.AboutUsDataResponse
import edu.nitt.deltaapp.core.model.FCM.FCMRegisterResponse
import edu.nitt.deltaapp.core.model.chat.ChatData
import edu.nitt.deltaapp.core.model.chat.ChatMessageSentResponse
import edu.nitt.deltaapp.core.model.event.EventDataResponse
import edu.nitt.deltaapp.core.model.event.EventRegisterResponse
import edu.nitt.deltaapp.core.model.payload.GuestLectures.GuestDataResponse
import edu.nitt.deltaapp.core.model.payload.Hospitality.HospitalityDataResponse
import edu.nitt.deltaapp.core.model.payload.Informals.InformalsDataResponse
import edu.nitt.deltaapp.core.model.event.RegisteredEventsResponse
import edu.nitt.deltaapp.core.model.payload.Clusters.ClustersDataResponse
import edu.nitt.deltaapp.core.model.payload.Gallery.GalleryDataResponse
import edu.nitt.deltaapp.core.model.payload.Schedule.ScheduleDataResponse
import edu.nitt.deltaapp.core.model.payload.Sponsors.SponsorsDataResponse
import edu.nitt.deltaapp.core.model.payload.Workshops.WorkshopDataResponse
import edu.nitt.deltaapp.core.model.user.DAuthResponse
import edu.nitt.deltaapp.core.model.user.CollegeResponse
import edu.nitt.deltaapp.core.model.user.LoginResponse
import edu.nitt.deltaapp.core.model.user.QrResponse
import edu.nitt.deltaapp.core.model.user.RegisterResponse
import edu.nitt.deltaapp.core.model.user.ScoreboardResponse
import edu.nitt.deltaapp.core.model.user.UpdateDetailsResponse
import edu.nitt.deltaapp.core.model.user.UserDetailsResponse
